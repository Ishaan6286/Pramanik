"""
Amazon Bedrock AI Service — Primary AI layer
Uses Amazon Nova Micro as the primary model.
...
Return ONLY the JSON, no other text."""
    ...
    text = _call_bedrock(prompt, max_tokens=3000)
    return _parse_json(text)
...
Return ONLY the JSON, no other text."""
    ...
    text = _call_bedrock(prompt, max_tokens=3000, temperature=0.4)
    return _parse_json(text)
